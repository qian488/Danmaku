    ...
    public static class PathHelper
    {
        ...
        public static string Combine(params string[] paths)
        {
            ...
            for (var index = 0; index < paths.Length - 1; index++)
            {
                ...
                if (path.EndsWith(separatorA, System.StringComparison.Ordinal) || path.EndsWith(separatorB, System.StringComparison.Ordinal))
                {
                    continue;
                }

                if (path.StartsWith(separatorA, System.StringComparison.Ordinal) || path.StartsWith(separatorB, System.StringComparison.Ordinal))
                {
                    continue;
                }
